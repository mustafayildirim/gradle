...
public class DefaultFileSystemSnapshotter implements FileSystemSnapshotter {
    ...
    private final AbsolutePathInputNormalizer normalizer;
    ...
    public DefaultFileSystemSnapshotter(FileHasher hasher, StringInterner stringInterner, FileSystem fileSystem, DirectoryFileTreeFactory directoryFileTreeFactory, FileSystemMirror fileSystemMirror) {
        ...
        this.normalizer = new DefaultAbsolutePathInputNormalizer(stringInterner, directoryFileTreeFactory, this);
    ...
    public Snapshot snapshotAll(final File file) {
        ...
        return producingAllSnapshots.guardByKey(path, new Factory<Snapshot>() {
            ...
            public Snapshot create() {
                ...
                if (snapshot == null) {
                    FileCollectionSnapshot fileCollectionSnapshot = normalizer.snapshot(ImmutableFileCollection.of(file), InputNormalizationStrategy.NOT_CONFIGURED);
    ...
    private PhysicalSnapshot snapshotAndCache(DirectoryFileTree directoryTree, PatternSet patterns) {
        PhysicalSnapshot fileSnapshot = snapshotSelf(directoryTree.getDir());
        MutableBoolean hasBeenFiltered = new MutableBoolean(false);
        PhysicalSnapshot visitableDirectoryTree = mirrorUpdatingDirectoryWalker.walk(fileSnapshot, patterns, hasBeenFiltered);
