...
public class DefaultFileCollectionFingerprint extends AbstractFileCollectionFingerprint implements CurrentFileCollectionFingerprint {
    ...
    public static CurrentFileCollectionFingerprint from(Iterable<PhysicalTreeSnapshot> roots, FingerprintingStrategy strategy) {
    ...
    private DefaultFileCollectionFingerprint(Map<String, NormalizedFileSnapshot> snapshots, FingerprintCompareStrategy compareStrategy, @Nullable Iterable<PhysicalTreeSnapshot> roots) {
