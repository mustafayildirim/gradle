...
public class MirrorUpdatingDirectoryWalker {
    ...
    public PhysicalSnapshot walk(final PhysicalSnapshot fileSnapshot, @Nullable PatternSet patterns, MutableBoolean hasBeenFiltered) {
        ...
        try {
            Files.walkFileTree(rootPath, EnumSet.of(FileVisitOption.FOLLOW_LINKS), Integer.MAX_VALUE, new java.nio.file.FileVisitor<Path>() {
                ...
                public FileVisitResult preVisitDirectory(Path dir, BasicFileAttributes attrs) {
                    ...
                    if (builder.isRoot() || isAllowed(dir, name, true, attrs, builder.getRelativePathTracker())) {
                ...
                public FileVisitResult visitFile(Path file, @Nullable BasicFileAttributes attrs) {
                    ...
                    if (isAllowed(file, name, false, attrs, builder.getRelativePathTracker())) {
                        if (attrs == null) {
                ...
                public FileVisitResult visitFileFailed(Path file, IOException exc) {
                    ...
                    if (isNotFileSystemLoopException(exc) && isAllowed(file, file.getFileName().toString(), false, null, builder.getRelativePathTracker())) {
