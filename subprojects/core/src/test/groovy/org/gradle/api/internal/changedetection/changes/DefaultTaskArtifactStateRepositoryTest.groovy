...
class DefaultTaskArtifactStateRepositoryTest extends AbstractProjectBuilderSpec {
    ...
    def setup() {
        ...
        FileCollectionSnapshotter inputFileCollectionNormalizer = new DefaultAbsolutePathInputNormalizer(stringInterner, TestFiles.directoryFileTreeFactory(), new DefaultFileSystemSnapshotter(fileHasher, stringInterner, TestFiles.fileSystem(), TestFiles.directoryFileTreeFactory(), fileSystemMirror))
        FileCollectionSnapshotter outputFileCollectionNormalizer = new DefaultOutputNormalizer(stringInterner, TestFiles.directoryFileTreeFactory(), new DefaultFileSystemSnapshotter(fileHasher, stringInterner, TestFiles.fileSystem(), TestFiles.directoryFileTreeFactory(), fileSystemMirror))
        ...
        inputFileCollectionNormalizer.registerSerializers(serializerRegistry)
        def snapshotterRegistry = new DefaultFileCollectionSnapshotterRegistry([inputFileCollectionNormalizer, outputFileCollectionNormalizer])
