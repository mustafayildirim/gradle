...
public class PreviousCompilationOutputAnalyzer {
    ...
    public PreviousCompilationOutputAnalyzer(StreamHasher hasher, ClassDependenciesAnalyzer analyzer, FileOperations fileOperations) {
        this.snapshotter = new DefaultClasspathEntrySnapshotter(hasher, analyzer, fileOperations);
    }
