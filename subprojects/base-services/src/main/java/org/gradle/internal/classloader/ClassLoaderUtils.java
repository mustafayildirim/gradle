...
public abstract class ClassLoaderUtils {
    ...
    private static class AbstractClassLoaderLookuper {
        ...
        protected MethodType methodType(Class<?> rtype, Class<?>[] ptypes) {
            try {
    ...
    private static class LookupClassDefiner extends AbstractClassLoaderLookuper implements ClassDefiner {
        private MethodType defineClassMethodType = methodType(Class.class, new Class[]{String.class, byte[].class, int.class, int.class});
    ...
    private static class LookupPackagesFetcher extends AbstractClassLoaderLookuper implements ClassLoaderPackagesFetcher {
        private MethodType getPackagesMethodType = methodType(Package[].class, new Class[]{});
        private MethodType getDefinedPackageMethodType = methodType(Package.class, new Class[]{String.class});
